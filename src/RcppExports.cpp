...
SEXP get_bucket_connection(std::string credentials, std::string project, std::string bucket, std::string file, bool isRead, bool istext, bool UTF8, bool autoOpen, size_t buffLength);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< size_t >::type buffLength(buffLengthSEXP);
