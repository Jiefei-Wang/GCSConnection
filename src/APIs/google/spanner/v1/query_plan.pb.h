...
public:
  ...
  PlanNode_ShortRepresentation_SubqueriesEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), s->size(), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.spanner.v1.PlanNode.ShortRepresentation.SubqueriesEntry.key");
 }
...
inline void PlanNode::clear_short_representation() {
  if (GetArenaNoVirtual() == nullptr && short_representation_ != nullptr) {
...
inline ::google::spanner::v1::PlanNode_ShortRepresentation* PlanNode::_internal_mutable_short_representation() {
  ...
  if (short_representation_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::spanner::v1::PlanNode_ShortRepresentation>(GetArenaNoVirtual());
