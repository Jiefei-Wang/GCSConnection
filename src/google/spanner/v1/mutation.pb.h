...
class Mutation_Write :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fspanner_2fv1_2fmutation_2eproto);
    return ::descriptor_table_google_2fspanner_2fv1_2fmutation_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::google::spanner::v1::Mutation_Write* Mutation::_internal_mutable_insert() {
  if (!_internal_has_insert()) {
    clear_operation();
    set_has_insert();
    operation_.insert_ = CreateMaybeMessage< ::google::spanner::v1::Mutation_Write >(
        GetArenaNoVirtual());
  }
...
inline ::google::spanner::v1::Mutation_Write* Mutation::_internal_mutable_update() {
  if (!_internal_has_update()) {
    clear_operation();
    set_has_update();
    operation_.update_ = CreateMaybeMessage< ::google::spanner::v1::Mutation_Write >(
        GetArenaNoVirtual());
  }
...
inline ::google::spanner::v1::Mutation_Write* Mutation::_internal_mutable_insert_or_update() {
  if (!_internal_has_insert_or_update()) {
    ...
    operation_.insert_or_update_ = CreateMaybeMessage< ::google::spanner::v1::Mutation_Write >(
        GetArenaNoVirtual());
  }
...
inline ::google::spanner::v1::Mutation_Write* Mutation::_internal_mutable_replace() {
  if (!_internal_has_replace()) {
    clear_operation();
    set_has_replace();
    operation_.replace_ = CreateMaybeMessage< ::google::spanner::v1::Mutation_Write >(
        GetArenaNoVirtual());
  }
...
inline ::google::spanner::v1::Mutation_Delete* Mutation::_internal_mutable_delete_() {
  if (!_internal_has_delete_()) {
    clear_operation();
    set_has_delete_();
    operation_.delete__ = CreateMaybeMessage< ::google::spanner::v1::Mutation_Delete >(
        GetArenaNoVirtual());
  }
