 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void CreateTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void CreateTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Creates a new table from the specified snapshot. The target table must
      // not exist. The snapshot and the table must be in the same instance.
      //
      // Note: This is a private alpha release of Cloud Bigtable snapshots. This
      ...
      virtual void CreateTableFromSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void CreateTableFromSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Lists all tables served from a specified instance.
      ...
      virtual void ListTables(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListTablesResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void ListTables(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListTablesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Gets metadata information about the specified table.
      ...
      virtual void GetTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void GetTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Permanently deletes a specified table and all of its data.
      ...
      virtual void DeleteTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void DeleteTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Performs a series of column family modifications on the specified table.
      // Either all or none of the modifications will occur before this method
      // returns, but data requests received prior to that point may see a table
      // where only some modifications have taken effect.
      ...
      virtual void ModifyColumnFamilies(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void ModifyColumnFamilies(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Permanently drop/delete a row range from a specified table. The request can
      // specify whether to delete all rows in a table, or only those that match a
      // particular prefix.
      ...
      virtual void DropRowRange(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void DropRowRange(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Generates a consistency token for a Table, which can be used in
      // CheckConsistency to check whether mutations to the table that finished
      // before this call started have been replicated. The tokens will be available
      // for 90 days.
      ...
      virtual void GenerateConsistencyToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void GenerateConsistencyToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Checks replication consistency based on a consistency token, that is, if
      // replication has caught up based on the conditions specified in the token
      // and the check request.
      ...
      virtual void CheckConsistency(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::CheckConsistencyResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void CheckConsistency(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::CheckConsistencyResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Creates a new snapshot in the specified cluster from the specified
      // source table. The cluster and the table must be in the same instance.
      //
      // Note: This is a private alpha release of Cloud Bigtable snapshots. This
      ...
      virtual void SnapshotTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void SnapshotTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Gets metadata information about the specified snapshot.
      //
      // Note: This is a private alpha release of Cloud Bigtable snapshots. This
      // feature is not currently available to most Cloud Bigtable customers. This
      ...
      virtual void GetSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Snapshot* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void GetSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Snapshot* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Lists all snapshots associated with the specified cluster.
      //
      // Note: This is a private alpha release of Cloud Bigtable snapshots. This
      // feature is not currently available to most Cloud Bigtable customers. This
      ...
      virtual void ListSnapshots(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListSnapshotsResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void ListSnapshots(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListSnapshotsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Permanently deletes the specified snapshot.
      //
      // Note: This is a private alpha release of Cloud Bigtable snapshots. This
      // feature is not currently available to most Cloud Bigtable customers. This
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void CreateTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) override;
      ...
      void CreateTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void CreateTableFromSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) override;
      ...
      void CreateTableFromSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void ListTables(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListTablesResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void ListTables(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListTablesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void GetTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) override;
      ...
      void GetTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void DeleteTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)>) override;
      ...
      void DeleteTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void ModifyColumnFamilies(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, std::function<void(::grpc::Status)>) override;
      ...
      void ModifyColumnFamilies(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void DropRowRange(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)>) override;
      ...
      void DropRowRange(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::protobuf::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void GenerateConsistencyToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void GenerateConsistencyToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void CheckConsistency(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::CheckConsistencyResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void CheckConsistency(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::CheckConsistencyResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void SnapshotTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) override;
      ...
      void SnapshotTable(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::longrunning::Operation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void GetSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Snapshot* response, std::function<void(::grpc::Status)>) override;
      ...
      void GetSnapshot(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::Snapshot* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void ListSnapshots(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListSnapshotsResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void ListSnapshots(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::bigtable::admin::v2::ListSnapshotsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
   ...
   public:
    ExperimentalWithCallbackMethod_CreateTable() {
      ::grpc::Service::experimental().MarkMethodCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CreateTableRequest, ::google::bigtable::admin::v2::Table>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::CreateTableRequest* request,
    ...
    void SetMessageAllocatorFor_CreateTable(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CreateTableRequest, ::google::bigtable::admin::v2::Table>*>(
    ...
    virtual void CreateTable(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::CreateTableRequest* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_CreateTableFromSnapshot() {
      ::grpc::Service::experimental().MarkMethodCallback(1,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CreateTableFromSnapshotRequest, ::google::longrunning::Operation>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::CreateTableFromSnapshotRequest* request,
                 ::google::longrunning::Operation* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->CreateTableFromSnapshot(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_CreateTableFromSnapshot(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CreateTableFromSnapshotRequest, ::google::longrunning::Operation>*>(
    ...
    virtual void CreateTableFromSnapshot(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::CreateTableFromSnapshotRequest* request, ::google::longrunning::Operation* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_ListTables() {
      ::grpc::Service::experimental().MarkMethodCallback(2,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ListTablesRequest, ::google::bigtable::admin::v2::ListTablesResponse>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::ListTablesRequest* request,
                 ::google::bigtable::admin::v2::ListTablesResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->ListTables(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_ListTables(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ListTablesRequest, ::google::bigtable::admin::v2::ListTablesResponse>*>(
    ...
    virtual void ListTables(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::ListTablesRequest* request, ::google::bigtable::admin::v2::ListTablesResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_GetTable() {
      ::grpc::Service::experimental().MarkMethodCallback(3,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GetTableRequest, ::google::bigtable::admin::v2::Table>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::GetTableRequest* request,
                 ::google::bigtable::admin::v2::Table* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->GetTable(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_GetTable(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GetTableRequest, ::google::bigtable::admin::v2::Table>*>(
    ...
    virtual void GetTable(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::GetTableRequest* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_DeleteTable() {
      ::grpc::Service::experimental().MarkMethodCallback(4,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DeleteTableRequest, ::google::protobuf::Empty>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::DeleteTableRequest* request,
                 ::google::protobuf::Empty* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->DeleteTable(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_DeleteTable(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DeleteTableRequest, ::google::protobuf::Empty>*>(
    ...
    virtual void DeleteTable(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::DeleteTableRequest* request, ::google::protobuf::Empty* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_ModifyColumnFamilies() {
      ::grpc::Service::experimental().MarkMethodCallback(5,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ModifyColumnFamiliesRequest, ::google::bigtable::admin::v2::Table>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::ModifyColumnFamiliesRequest* request,
                 ::google::bigtable::admin::v2::Table* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->ModifyColumnFamilies(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_ModifyColumnFamilies(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ModifyColumnFamiliesRequest, ::google::bigtable::admin::v2::Table>*>(
    ...
    virtual void ModifyColumnFamilies(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::ModifyColumnFamiliesRequest* request, ::google::bigtable::admin::v2::Table* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_DropRowRange() {
      ::grpc::Service::experimental().MarkMethodCallback(6,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DropRowRangeRequest, ::google::protobuf::Empty>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::DropRowRangeRequest* request,
                 ::google::protobuf::Empty* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->DropRowRange(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_DropRowRange(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DropRowRangeRequest, ::google::protobuf::Empty>*>(
    ...
    virtual void DropRowRange(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::DropRowRangeRequest* request, ::google::protobuf::Empty* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_GenerateConsistencyToken() {
      ::grpc::Service::experimental().MarkMethodCallback(7,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GenerateConsistencyTokenRequest, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->GenerateConsistencyToken(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_GenerateConsistencyToken(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GenerateConsistencyTokenRequest, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse>*>(
    ...
    virtual void GenerateConsistencyToken(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::GenerateConsistencyTokenRequest* request, ::google::bigtable::admin::v2::GenerateConsistencyTokenResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_CheckConsistency() {
      ::grpc::Service::experimental().MarkMethodCallback(8,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CheckConsistencyRequest, ::google::bigtable::admin::v2::CheckConsistencyResponse>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::CheckConsistencyRequest* request,
                 ::google::bigtable::admin::v2::CheckConsistencyResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->CheckConsistency(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_CheckConsistency(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::CheckConsistencyRequest, ::google::bigtable::admin::v2::CheckConsistencyResponse>*>(
    ...
    virtual void CheckConsistency(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::CheckConsistencyRequest* request, ::google::bigtable::admin::v2::CheckConsistencyResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_SnapshotTable() {
      ::grpc::Service::experimental().MarkMethodCallback(9,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::SnapshotTableRequest, ::google::longrunning::Operation>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::SnapshotTableRequest* request,
                 ::google::longrunning::Operation* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->SnapshotTable(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_SnapshotTable(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::SnapshotTableRequest, ::google::longrunning::Operation>*>(
    ...
    virtual void SnapshotTable(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::SnapshotTableRequest* request, ::google::longrunning::Operation* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_GetSnapshot() {
      ::grpc::Service::experimental().MarkMethodCallback(10,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GetSnapshotRequest, ::google::bigtable::admin::v2::Snapshot>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::GetSnapshotRequest* request,
    ...
    void SetMessageAllocatorFor_GetSnapshot(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::GetSnapshotRequest, ::google::bigtable::admin::v2::Snapshot>*>(
    ...
    virtual void GetSnapshot(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::GetSnapshotRequest* request, ::google::bigtable::admin::v2::Snapshot* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_ListSnapshots() {
      ::grpc::Service::experimental().MarkMethodCallback(11,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ListSnapshotsRequest, ::google::bigtable::admin::v2::ListSnapshotsResponse>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::ListSnapshotsRequest* request,
    ...
    void SetMessageAllocatorFor_ListSnapshots(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::ListSnapshotsRequest, ::google::bigtable::admin::v2::ListSnapshotsResponse>*>(
    ...
    virtual void ListSnapshots(::grpc::ServerContext* context, const ::google::bigtable::admin::v2::ListSnapshotsRequest* request, ::google::bigtable::admin::v2::ListSnapshotsResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_DeleteSnapshot() {
      ::grpc::Service::experimental().MarkMethodCallback(12,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DeleteSnapshotRequest, ::google::protobuf::Empty>(
          [this](::grpc::ServerContext* context,
                 const ::google::bigtable::admin::v2::DeleteSnapshotRequest* request,
                 ::google::protobuf::Empty* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
    ...
    void SetMessageAllocatorFor_DeleteSnapshot(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::bigtable::admin::v2::DeleteSnapshotRequest, ::google::protobuf::Empty>*>(
  ...
  class ExperimentalWithRawCallbackMethod_CreateTableFromSnapshot : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(1,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->CreateTableFromSnapshot(context, request, response, controller);
                 }));
    }
    ...
    virtual void CreateTableFromSnapshot(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_ListTables : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(2,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->ListTables(context, request, response, controller);
                 }));
    }
    ...
    virtual void ListTables(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_GetTable : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(3,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->GetTable(context, request, response, controller);
                 }));
    }
    ...
    virtual void GetTable(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_DeleteTable : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(4,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->DeleteTable(context, request, response, controller);
                 }));
    }
    ...
    virtual void DeleteTable(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_ModifyColumnFamilies : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(5,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->ModifyColumnFamilies(context, request, response, controller);
                 }));
    }
    ...
    virtual void ModifyColumnFamilies(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_DropRowRange : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(6,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->DropRowRange(context, request, response, controller);
                 }));
    }
    ...
    virtual void DropRowRange(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_GenerateConsistencyToken : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(7,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->GenerateConsistencyToken(context, request, response, controller);
                 }));
    }
    ...
    virtual void GenerateConsistencyToken(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_CheckConsistency : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(8,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->CheckConsistency(context, request, response, controller);
                 }));
    }
    ...
    virtual void CheckConsistency(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_SnapshotTable : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(9,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->SnapshotTable(context, request, response, controller);
                 }));
    }
    ...
    virtual void SnapshotTable(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
